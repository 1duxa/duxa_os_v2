...
use constants::{PhysAddr, VirtAddr};
...
pub unsafe fn walky_talky(
    ...
    let p3 = phys_to_virt(entry_addr(p4e), phys_map) as *mut PageTable;
    ...
    let p2 = phys_to_virt(entry_addr(p3e), phys_map) as *mut PageTable;
    ...
    let p1 = phys_to_virt(entry_addr(p2e), phys_map) as *mut PageTable;
